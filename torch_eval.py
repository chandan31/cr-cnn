...
if __name__=="__main__":
    ...
    os.system('perl SemEval2010_task8_all_data' + os.sep + 'SemEval2010_task8_scorer-v1.2' + os.sep + 'semeval2010_task8_scorer-v1.2.pl' + ' ' + result+'pred_ori.txt' + ' '+ result + 'true_ori.txt'+ ' > '+result+'result_chandan.txt')
    
    F_score = open(result+'result_chandan.txt', 'r').readlines()
