...
with tf.Session() as sess:
    ...
    accuracies = []
    valid_accuracies = []
    for epoch_idx in range(len(SGD_lrate2)):
        ...
        os.system('python torch_eval_valid.py rec_cnv3_filter_valid_predictions valid_targets')
        ...
        #    for item in target:
        #        f.write("%s\n" % item)        
        os.system('python torch_eval.py rec_cnv3_filter_test_predictions test_target_modified')
        print('--------------------------------------------')
        print('\n')
    print(accuracies)    
