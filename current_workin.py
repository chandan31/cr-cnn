...
#################################################################################################################
outputs_forward, state_forward = tf.contrib.rnn.static_rnn(cell, inputs_forward, initial_state=init_state_forward, scope="LSTM1")
outputs_backward, state_backward = tf.contrib.rnn.static_rnn(cell1, inputs_backward, initial_state=init_state_backward, scope="LSTM2")

POS_outputs_f, POS_state_f = tf.contrib.rnn.static_rnn(cell_POS_f, inputs_forward_POS, initial_state=init_state_POS_forward, scope="POS_LSTM1")
POS_outputs_r, POS_state_r = tf.contrib.rnn.static_rnn(cell_POS_r, inputs_backward_POS, initial_state=init_state_POS_backward, scope="POS_LSTM2")

Wnet_outputs_f, Wnet_state_f = tf.contrib.rnn.static_rnn(cell_WNET_f, inputs_forward_WNET, initial_state=init_state_WNET_forward, scope="WNET_LSTM1")
Wnet_outputs_r, Wnet_state_r = tf.contrib.rnn.static_rnn(cell_WNET_r, inputs_backward_WNET, initial_state=init_state_WNET_backward, scope="WNET_LSTM2")

GR_outputs_f, GR_state_f = tf.contrib.rnn.static_rnn(cell_GR_f, inputs_forward_GR, initial_state=init_state_GR_forward, scope="GR_LSTM1")
GR_outputs_r, GR_state_r = tf.contrib.rnn.static_rnn(cell_GR_r, inputs_backward_GR, initial_state=init_state_GR_backward, scope="GR_LSTM2")
...
with tf.Session() as sess:
    ...
    for epoch_idx in range(num_epochs):
        ...
        for batch_idx in range(num_batches):
            ...
            _total_loss, _train_step,_current_state_forward,_current_state_backward,_current_state_POS_f,_current_state_POS_r,_current_state_Wnet_f,_current_state_Wnet_r,_current_state_GR_f,_current_state_GR_r,_predictions  = sess.run(
                            [cost, train_step, state_forward, state_backward, POS_state_f, 
                            POS_state_r, Wnet_state_f,Wnet_state_f, GR_state_f,GR_state_r, predictions],
                            feed_dict={
                                ...
                                cell_state_WNET_forward: _current_cell_state_Wnet_forward,
                                hidden_state_WNET_forward: _current_hidden_state_Wnet_forward,
                                cell_state_WNET_backward: _current_cell_state_Wnet_backward,
                                hidden_state_WNET_backward: _current_hidden_state_Wnet_backward,
                                cell_state_GR_forward: _current_cell_state_GR_forward,
                                hidden_state_GR_forward: _current_hidden_state_GR_forward,
                                cell_state_GR_backward: _current_cell_state_GR_backward,
                                hidden_state_GR_backward: _current_hidden_state_GR_backward
                            })
            ...
            _current_cell_state_Wnet_forward, _current_hidden_state_Wnet_forward = _current_state_Wnet_f
            _current_cell_state_Wnet_backward, _current_hidden_state_Wnet_backward = _current_state_Wnet_r
            _current_cell_state_GR_forward, _current_hidden_state_GR_forward = _current_state_GR_f
            _current_cell_state_GR_backward, _current_hidden_state_GR_backward = _current_state_GR_r
        ...
        for batch_idx in range(test_batches):
            ...
            #print(test)
            test_predictions, _accuracy, _current_state_forward,_current_state_backward,_current_state_POS_f,_current_state_POS_r,_current_state_Wnet_f,_current_state_Wnet_r,_current_state_GR_f,_current_state_GR_r   = sess.run(
                    [predictions, accuracy, state_forward, state_backward, POS_state_f, 
                    POS_state_r, Wnet_state_f,Wnet_state_f, GR_state_f,GR_state_r],
                    feed_dict={
        ...
        print('Flase Positive shape', True_positive.shape)
