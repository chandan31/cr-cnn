...
f = gzip.open('./sem-relations_1.pkl.gz', 'rb')
data = pkl.load(f)
f.close()
...
train_raw, train_pos1, train_pos2 = data['train_set']
test_raw, test_pos1, test_pos2 = data['test_set']
wn_num  = 10
pos_num = 15
gr_num  = 19
...
W_raw = tf.get_variable("Filter_raw", shape=[3, 250, nb_filter_raw],
